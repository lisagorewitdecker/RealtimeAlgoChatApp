# RealtimeAlgoChatApp Design System design system
...
workspace package (`@workspace/realtime-algo-chat-design-system`): other artifacts depend
...
- `docs/references/component-inventory.md` — the source-backed component catalog,
  chunk plan, and implementation status.
- `docs/references/components/` — one evidence file per source component family.
- `docs/references/logos/` — the genuine RealtimeAlgoChatApp icon retained from
  the Expo app.
- The imported catalog contains ScaledText, ScaledTextInput,
  KeyboardAwareForm, RoomCard, MessageBubble, StatusCard,
  AppleSignInButton, ErrorBoundary/ErrorFallback, and AppFooter.
...
`@workspace/realtime-algo-chat-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/realtime-algo-chat-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/realtime-algo-chat-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/realtime-algo-chat-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/realtime-algo-chat-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/realtime-algo-chat-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/realtime-algo-chat-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/realtime-algo-chat-design-system/docs/migrating-expo.md`
...
- User-facing text scales with the in-app preference, including line height, and
  never renders below 12px.
- Use blue for primary actions, green for online/success states, and red only for
  destructive or error states.
- Preserve 44px minimum touch targets, clear disabled states, and explicit
  confirmation for destructive actions.
- The default and light token modes are intentionally dark-first. High contrast
  remains an app accessibility mode rather than a third design-system theme.
