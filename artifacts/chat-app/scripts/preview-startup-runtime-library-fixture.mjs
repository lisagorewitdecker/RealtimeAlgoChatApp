...
export const fixtureOutput = Object.freeze({
  ...
  "missing-runtime-library-malformed-trailing": "Error: The code execution cannot proceed because libgtk-3-0.dll was not found. trailing unrelated loader text\n",
  "missing-runtime-library-malformed-followed-by-valid": "Error: The code execution cannot proceed because \"C:\\Program Files\\Expo\\React Native DevTools\\libgtk-3-0.dll was not found.\nError: The code execution cannot proceed because libgtk-3-0.dll was not found. Reinstalling the program may fix this problem.\n",
