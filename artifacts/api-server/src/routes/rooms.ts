...
function setAiBusy(busy){aiAskBtn.disabled=busy;aiRetryBtn.hidden=busy||aiRetryBtn.dataset.available!=='true';aiStopBtn.hidden=!busy}
function setAiRetryAvailable(available){aiRetryBtn.dataset.available=available?'true':'false';aiRetryBtn.hidden=!available||!!aiActive||!!aiCountdown}
