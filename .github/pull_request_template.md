...
<!-- For an intentional versioned break, add both declarations to the pull request description. Replace the placeholders below when this pull request intentionally breaks the versioned API contract. -->
