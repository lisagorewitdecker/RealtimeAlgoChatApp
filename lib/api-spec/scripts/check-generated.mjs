...
const terminationGraceMs = Number.parseInt(
  process.env.API_CODEGEN_CHECK_TERMINATION_GRACE_MS ?? "5000",
  10,
);
...
async function main() {
  ...
  if (interruptedSignal) {
    ...
    console.error("");
    console.error(`Run \`${regenerationCommand}\` and commit the generated output.`);
    exitCode = 1;
  }
