...
# pass that same value to every device-sensitive native consumer. This static contract runs on
...
assert_workflow_device_handoff "Send controlled iOS JavaScript error"
assert_contains \
  "$(<"$SENTRY_GATE")" \
