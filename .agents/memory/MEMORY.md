...
- [GitHub connection workflow scope](github-connection-workflow-scope.md) — it cannot touch workflow files or logs; shell/Git-pane pushes need a valid Git Providers grant or an owner PAT; check redactions before pushing.
